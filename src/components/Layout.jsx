...
import avatar from "../assets/2754575_man_avatar_male_icon.svg";
import avatar2 from "../assets/2754579_business man_man_avatar_icon.png";
...
const Layout = ({ children }) => {
  ...
  return (
    <div className="layout">
      <div className="header" style={{ background: "#FFE6CE" }}>
